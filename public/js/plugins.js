!function (t) {
    ...
    var d = {}, p = {}, f = [], h = window.fixim || [], m = window.jQuery, v = m(window), g = m(document), y = m.isFunction, w = d._ = n(18), x = n(3) && m.tram, b = !1, k = !1, z = window.Modernizr;
    ...
    var _ = navigator.userAgent.toLowerCase(), A = navigator.appVersion.toLowerCase(), T = d.env.touch = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch, B = d.env.chrome = /chrome/.test(_) && /Google/.test(navigator.vendor) && parseInt(A.match(/chrome\/(\d+)\./)[1], 10), O = d.env.ios = z && z.ios;
    ...
    var E = "resize.fixim orientationchange.fixim load.fixim", L = "scroll.fixim " + E;
    ...
    i.triggers = {}, i.types = {INTRO: "w-ix-intro" + r, OUTRO: "w-ix-outro" + r}, i.init = function () {
    ...
    window.tram = function (t) {
        ...
        function i(t) {
            var e = parseInt(t.slice(1), 16), n = e >> 16 & 255, i = e >> 8 & 255, o = 255 & e;
            return [n, i, o]
        }
        ...
        var l = function (t, e, n) {
            ...
            function a(s, c) {
                ...
                return f.constructor = u, u.mixin = function (e) {
                    ...
                    if (d = {}, o(t) ? d = t.call(u, f, p, u, s) : i(t) && (d = t), i(d))for (var n in d)e.call(d, n) && (f[n] = d[n]);
        ...
        }, f = document, h = window, m = "bkwld-tram", v = /[\-\.0-9]/g, g = /[A-Z]/, y = "number", w = /^(rgb|#)/, x = /(em|cm|mm|in|pt|pc|px)$/, b = /(em|cm|mm|in|pt|pc|px|%)$/, k = /(deg|rad|turn)$/, z = "unitless", _ = /(all|none) 0s ease 0s/, A = /^(width|height)$/, T = " ", B = f.createElement("a"), O = ["Webkit", "Moz", "O", "ms"], C = ["-webkit-", "-moz-", "-o-", "-ms-"], E = function (t) {
            if (t in B.style)return {dom: t, css: t};
            var e, n, i = "", o = t.split("-");
            for (e = 0; e < o.length; e++)i += o[e].charAt(0).toUpperCase() + o[e].slice(1);
            for (e = 0; e < O.length; e++)if (n = O[e] + i, n in B.style)return {dom: n, css: C[e] + t}
        }, L = e.support = {
        ...
        if (L.transition) {
            var j = L.timing.dom;
            if (B.style[j] = d["ease-in-back"][0], !B.style[j])for (var M in p)d[M][0] = p[M]
        }
        var I = e.frame = function () {
            ...
            var t = h.performance, e = t && (t.now || t.webkitNow || t.msNow || t.mozNow);
            ...
            function a() {
                ...
                if (i)for (I(a), e = q(), t = i; t--;)n = f[t], n && n.render(e)
            }
        ...
        var Y = t.style, W = t.css, U = {transform: L.transform && L.transform.css}, G = {
            color: [R, w],
    ...
    i.define("dropdown", t.exports = function (t, e) {
        ...
        function a(t) {
            t.config = {hover: Boolean(t.el.attr("data-hover")) && !b, delay: Number(t.el.attr("data-delay")) || 0}
        }
        ...
        var v, g, y = {}, w = t(document), x = i.env(), b = i.env.touch, k = ".w-dropdown", z = "w--open", _ = "w-close" + k, A = o.triggers;
    ...
    i.define("edit", t.exports = function (t, e, n) {
        ...
        if (n = n || {}, (i.env("test") || i.env("frame")) && !n.fixture)return {exit: 1};
        var d, p = {}, f = t(window), h = t(document.documentElement), m = document.location, v = "hashchange", g = n.load || r, y = !1;
        try {
    ...
    i.define("forms", t.exports = function (t, e) {
        ...
        function u(e, n) {
            ...
            return n = n || {}, e.find(':input:not([type="submit"])').each(function (o, r) {
                var a = t(r), s = a.attr("type"), c = a.attr("data-name") || a.attr("name") || "Field " + (o + 1), u = a.val();
        ...
        var m = {};
        n(19);
        var v, g, y, w = t(document), x = window.location, b = window.XDomainRequest && !window.atob, k = ".w-form", z = /e(\-)?mail/i, _ = /^\S+@\S+$/, A = window.alert, T = /list-manage[1-9]?.com/i, B = e.debounce(function () {
    ...
    i.define("ix", t.exports = function (t, e) {
        ...
        function u() {
            for (var t = x.scrollTop(), e = x.height(), n = C.length, i = 0; n > i; i++) {
                var o = C[i], r = o.el, a = o.trigger, s = a.stepsB && a.stepsB.length, c = o.state, u = r.offset().top, l = r.outerHeight(), d = o.offsetTop, f = o.offsetBot;
        ...
        var g, y, w = {}, x = t(window), b = ".w-ix", k = t.tram, z = i.env, _ = z(), A = z.chrome && z.chrome < 35, T = "none 0s ease 0s", B = t(), O = {}, C = [], E = [], L = [], j = 1, M = {
    ...
    function i(t, e, n) {
        ...
        var y, w, x, b = n.tram, k = Array.isArray, z = "w-lightbox", _ = z + "-", A = /(^|\s+)/g, T = [];
        i.build = function () {
            return i.destroy(), w = {
            ...
            if (t !== y) {
                ...
                return c(r, function (i) {
                    ...
                    if (t === y) {
                        var a, s, c = v("figure", "figure").append(f(i, "image")), l = v("frame").append(c), d = v("view").append(l);
        ...
        return l.prototype.show = function () {
            ...
            var i = t.navigator.userAgent, o = /(iPhone|iPad|iPod);[^OS]*OS (\d)/, r = i.match(o), a = i.indexOf("Android ") > -1 && -1 === i.indexOf("Chrome");
            if (a || r && !(r[2] > 7)) {
    ...
    o.define("lightbox", t.exports = function (t, e) {
        ...
        var c, u, l, d, p = {}, f = i(window, document, t), h = t(document), m = o.env(), v = ".w-lightbox";
    ...
    i.define("links", t.exports = function (t, e) {
        ...
        function r() {
            ...
            e.each(c, function (e) {
                var i = e.link, o = e.sec, r = o.offset().top, c = o.outerHeight(), u = .5 * n, l = o.is(":visible") && r + c - u >= t && t + n >= r + u;
        ...
        var s, c, u, l = {}, d = t(window), p = i.env(), f = window.location, h = document.createElement("a"), m = "w--current", v = /^#[a-zA-Z][\w:.-]*$/, g = /index\.(html|php)$/, y = /\/$/;
    ...
    i.define("maps", t.exports = function (t, e) {
        ...
        function o() {
            ...
            d = f.find(m), d.length && (null === h ? (t.getScript("https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&callback=_wf_maps_loaded&key=AIzaSyBUFJdkmafyXn2OXF-B5kz2qDW8P0cUfB4"), window._wf_maps_loaded = e) : e())
        }
        ...
        function l(e, n) {
            ...
            o.map = new h.maps.Map(e, {
                ...
                var t = 0, e = 0, n = r.css(["paddingTop", "paddingRight", "paddingBottom", "paddingLeft"]);
    ...
    i.define("navbar", t.exports = function (t, e) {
        ...
        function d(t) {
            var n = {}, i = t.config || {}, o = n.animation = t.el.attr("data-animation") || "default";
        ...
        function g(e, n) {
            var i = t.data(n, L), o = i.collapsed = "none" !== i.button.css("display");
        ...
        function w(t, e) {
            if (!t.open) {
                ...
                var r = x(t), a = t.menu.outerHeight(!0), s = t.menu.outerWidth(!0), c = t.el.height(), u = t.el[0];
        ...
        function b(t, e) {
            ...
            if (t.open) {
                ...
                var o = "transform " + i.duration + "ms " + i.easing2, r = t.menu.outerHeight(!0), a = t.menu.outerWidth(!0), s = t.el.height();
                if (i.animOver)return void T(t.menu).add(o).start({x: a * i.animDirect}).then(n);
                var c = s + r;
                T(t.menu).add(o).start({y: -c}).then(n)
            }
        }

        var k, z, _, A = {}, T = t.tram, B = t(window), O = t(document), C = i.env(), E = '<div class="w-nav-overlay" data-wf-ignore />', L = ".w-nav", j = "w--open", M = "w--nav-menu-open", I = "w--nav-link-open", q = o.triggers;
    ...
    i.define("scroll", t.exports = function (t, e) {
        ...
        function r(e, n) {
            if (f.test(e)) {
                ...
                if (o.length) {
                    ...
                    var s = i.env("editor") ? ".w-editor-body" : "body", c = t("header, " + s + " > .header, " + s + " > .w-nav:not([data-no-scroll])"), u = "fixed" === c.css("position") ? c.outerHeight() : 0;
        ...
        function a(e, n) {
            ...
            var u = Date.now(), d = l.requestAnimationFrame || l.mozRequestAnimationFrame || l.webkitRequestAnimationFrame || function (t) {
                    l.setTimeout(t, 15)
                }, p = (472.143 * Math.log(Math.abs(i - o) + 125) - 2e3) * c, f = function () {
                var t = Date.now() - u;
        ...
        var u = t(document), l = window, d = l.location, p = n() ? null : l.history, f = /^[a-zA-Z0-9][\w:.-]*$/;
        return {ready: o}
    })
}, function (t, e, n) {
    "use strict";
    ...
    i.define("slider", t.exports = function (t, e) {
        ...
        function v(e, n) {
            ...
            var u = e.offsetX || 0, l = e.offsetX = -r[e.index].x, d = {
                x: l,
                opacity: 1,
                visibility: ""
            }, p = t(r[e.index].els), f = t(r[e.previous] && r[e.previous].els), h = e.slides.not(p), m = o.animation, v = o.easing, g = Math.round(o.duration), y = n.vector || (e.index > e.previous ? 1 : -1), w = "opacity " + g + "ms " + v, x = "transform " + g + "ms " + v;
        ...
        function y(e) {
            ...
            0 > s && (s = 0), e.anchors = [{els: [], x: 0, width: 0}], e.slides.each(function (c, u) {
        ...
        var k, z, _, A, T = {}, B = t.tram, O = t(document), C = i.env(), E = ".w-slider", L = '<div class="w-slider-dot" data-wf-ignore />', j = o.triggers;
    ...
    i.define("tabs", t.exports = function (t, e) {
        ...
        var p, f, h, m = {}, v = t.tram, g = (t(window), t(document)), y = i.env, w = y.safari, x = y(), b = "data-w-tab", k = ".w-tabs", z = "w--current", _ = "w--tab-active", A = o.triggers;
    ...
    i.define("touch", t.exports = function (t, e) {
        function n(t) {
            ...
            function n(t) {
                if (d) {
                    ...
                    var e = t.touches, n = e ? e[0].clientX : t.clientX, o = e ? e[0].clientY : t.clientY, s = n - l;
            ...
            var c, u, l, d = !1, p = !1, f = !1, h = Math.min(Math.round(.04 * window.innerWidth), 40);
        ...
        return r && (t.event.special.tap = {bindType: "click", delegateType: "click"}), o.init = function (e) {
    ...
    t.exports = function () {
        ...
        var e = {}, n = Array.prototype, i = Object.prototype, r = Function.prototype, a = (n.push, n.slice), s = (n.concat, i.toString, i.hasOwnProperty), c = n.forEach, u = n.map, l = (n.reduce, n.reduceRight, n.filter), d = (n.every, n.some), p = n.indexOf, f = (n.lastIndexOf, Array.isArray, Object.keys), h = (r.bind, t.each = t.forEach = function (n, i, o) {
            if (null == n)return n;
            if (c && n.forEach === c)n.forEach(i, o); else if (n.length === +n.length) {
                for (var r = 0, a = n.length; a > r; r++)if (i.call(o, n[r], r, n) === e)return
            } else for (var s = t.keys(n), r = 0, a = s.length; a > r; r++)if (i.call(o, n[s[r]], s[r], n) === e)return;
            return n
        });
        ...
        return t.template = function (e, n, i) {
            ...
            var o = RegExp([(n.escape || v).source, (n.interpolate || v).source, (n.evaluate || v).source].join("|") + "|$", "g"), r = 0, a = "__p+='";
                    ...
                    return {
                        send: function (e, n) {
                            ...
                            s = new XDomainRequest, /^\d+$/.test(r.timeout) && (s.timeout = r.timeout), s.ontimeout = function () {
                                ...
                                try {
                                    if ("html" === a || /text\/html/i.test(s.contentType))o.html = s.responseText; else if ("json" === a || "text" !== a && /\/json/i.test(s.contentType))try {
    ...
    value: {
        ...
        triggers: [{
            ...
            siblings: !0,
            stepsA: [{display: "block", height: "auto", transition: "height 500ms ease 0ms"}],
            stepsB: []
        }]
    }
}, {
    ...
    value: {style: {display: "none", opacity: 0, x: "0px", y: "-25px", z: "0px"}, triggers: []}
}, {
    ...
    value: {
        ...
        triggers: [{
            ...
            descend: !0,
            stepsA: [{transition: "transform 300ms ease 0ms", x: "0px", y: "0px", z: "0px"}],
            stepsB: [{transition: "transform 300ms ease 0ms", x: "0px", y: "75%", z: "0px"}]
        }]
    }
}, {
    ...
    value: {
        ...
        triggers: [{
            ...
            stepsB: [{transition: "transform 300ms ease 0ms", x: "0px", y: "20px", z: "0px"}]
        }]
    }
}, {
    ...
    value: {
        ...
        triggers: [{
            ...
            selector: ".blog-link",
            descend: !0,
            stepsA: [{transition: "transform 1000ms ease 0ms", scaleX: 1.3, scaleY: 1.3, scaleZ: 1}],
            stepsB: [{transition: "transform 1000ms ease 0ms", scaleX: 1, scaleY: 1, scaleZ: 1}]
        }, {
            type: "hover",
    ...
    value: {
        ...
        triggers: [{
            ...
            stepsA: [{opacity: 0, transition: "opacity 200ms ease 0ms"}],
            stepsB: [{opacity: 1, transition: "opacity 200ms ease 0ms"}]
        }, {type: "click", selector: ".cnt-content", stepsA: [{display: "none"}], stepsB: [{display: "block"}]}]
    }
}, {
    slug: "dispnay-none-on-load-project-info",
    name: "dispnay none on load project info",
    value: {style: {display: "none", opacity: 0, x: "-100px", y: "0px", z: "0px"}, triggers: []}
}, {
    ...
    value: {
        ...
        triggers: [{
            ...
            siblings: !0,
            stepsA: [{width: "100%", transition: "opacity 500ms ease 0ms, width 300ms ease 0ms"}],
    ...
    value: {style: {display: "none", opacity: 0, x: "0px", y: "-20px", z: "0px"}, triggers: []}
}, {
    ...
    value: {
        ...
        triggers: [{
            ...
            stepsA: [{display: "block", opacity: 1, transition: "opacity 300ms ease 0ms"}],
            stepsB: [{opacity: 0, transition: "opacity 300ms ease 0ms"}, {display: "none"}]
        }]
    }
}, {
...
}, {slug: "cart-hide", name: "cart hide", value: {style: {display: "none"}, triggers: []}}, {
    slug: "cart-product",
    name: "cart product",
    value: {
        style: {},
